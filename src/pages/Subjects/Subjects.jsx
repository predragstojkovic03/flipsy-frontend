...
const Subjects = () => {
    return(
        <main>
            <div className={styles.back_icon_wraper}>
                <SlArrowLeftCircle />
            </div>
            <div className={styles.container}>
                ...
                <div className={styles.donjiDeo}>
                    ...
                    <div className={styles.pretraga}>
                        ...
                        <input className={styles.input_pretraga} placeholder="pretrazi predmet"/>
                    </div>
                    <div className={styles.predmeti}>
                        <div className={styles.vrste}>
                            <div className={styles.predmet} id={styles.predmet1}>
                                <div className={styles.predmet_icon}>
                                <BsGraphUpArrow /></div><br />
                                Ekonomija</div>
                            <div className={styles.predmet} id={styles.predmet2}>
                            <div className={styles.predmet_icon}>
                            <TbMathFunction /></div><br />
                            Matematika 1</div>
                        </div>
                        <div className={styles.vrste}>
                            <div className={styles.predmet} id={styles.predmet3}>
                            <div className={styles.predmet_icon}>
                            <FaComputer /></div><br />
                            OIKT</div>
                            <div className={styles.predmet} id={styles.predmet4}>
                            <div className={styles.predmet_icon}>
                            <FaBook /></div><br />
                            Engleski jezik</div>
                        </div>
                        <div className={styles.vrste}>
                            <div className={styles.predmet} id={styles.predmet5}>
                            <div className={styles.predmet_icon}>
                            <FaPeopleGroup /></div><br />
                            Menadžment</div>
                            <div className={styles.predmet} id={styles.predmet6}>
                            <div className={styles.predmet_icon}>
                            <GiBrain /></div><br />
                            Psihologija</div>
                        </div>
